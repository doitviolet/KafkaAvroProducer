...
public class Utils {
    public static Map findAndReadConfigFile(String name, boolean mustExist) {
        ...
        try {
            ...
            if (mustExist) {
                if(confFileEmpty)
                    throw new RuntimeException("Config file " + name + " doesn't have any valid flink configs");
                else
        ...
        if (resources.isEmpty()) {
            ...
            throw new IOException(
                    "Found multiple " + configFilePath
                            + " resources. You're probably bundling the flink jars with your topology jar. "
                            + resources);
        } else {
